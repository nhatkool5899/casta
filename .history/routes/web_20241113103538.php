...
Route::get('/ho-tro-doanh-nghiep', [PagesController::class, 'about_1']);
Route::get('/thu-nghiem-khao-nghiem-cong-nghe', [PagesController::class, 'about_1']);
Route::get('/dao-tao', [PagesController::class, 'about_1']);
