                            ...
                            <div class="nav_mobile-menu">
                                <ul class="nav_mobile-list">
                                    ...
                                    <li class="nav-item slide-drop">
                                        ...
                                        <ul class="submenu">
                                            <li class="submenu-item">
                                                <a href="{{url('chuyen-giao-cong-nghe')}}" class="submenu-link">Chuyển giao công nghệ</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{url('ho-tro-doanh-nghiep')}}" class="submenu-link">Hỗ trợ doanh nghiệp</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{url('thuc-nghiem-khao-nghiem-cong-nghe')}}" class="submenu-link">Thực nghiệm - Khảo nghiệm công nghệ</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{url('dao-tao')}}" class="submenu-link">Đào tạo</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="nav-item slide-drop">
                                        ...
                                        <ul class="submenu">
                                            <li class="submenu-item">
                                                <a href="{{url('su-kien')}}" class="submenu-link">Sự kiên</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{url('tin-tuc')}}" class="submenu-link">Tin tức</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{url('metag+')}}" class="submenu-link">MetaG+</a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <ul class="navigation">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="submenu">
                                        <ul class="submenu-list">
                                            <li class="submenu-item">
                                                <a href="{{ url('su-kien') }}" class="submenu-link about-redirect" data-section="section1">
                                                    <span>Sự kiện</span>
                                                </a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{ url('tin-tuc') }}" class="submenu-link about-redirect" data-section="section2">
                                                    <span>Tin tức</span>
                                                </a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{ url('metag+') }}" class="submenu-link about-redirect" data-section="section2">
                                                    <span>MetaG+</span>
                                                </a>
                                            </li>
                                        </ul>
