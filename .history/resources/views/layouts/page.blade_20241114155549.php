                                ...
                                <ul class="nav_mobile-list">
                                    ...
                                    <li class="nav-item slide-drop">
                                        ...
                                        <ul class="nav-submobile submobile">
                                            ...
                                            <li class="nav-submobile-item">
                                                <a href="{{url('thu-nghiem-khao-nghiem-cong-nghe')}}" class="nav-submobile-link">Thực nghiệm - Khảo nghiệm công nghệ</a>
                                            </li>
                                            <li class="nav-submobile-item">
                                    ...
                                    <li class="nav-item slide-drop">
                                        ...
                                        <ul class="nav-submobile submobile">
                                            ...
                                            <li class="nav-submobile-item">
                                                <a href="{{url('lien-he')}}" class="nav-submobile-link">Liên hệ</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <div class="submenu">
                                        <ul class="submenu-list">
                                            <li class="submenu-item">
                                                <a href="{{ url('chuyen-giao-cong-nghe') }}" class="submenu-link">
                                                    <span>Chuyển giao công nghệ</span>
                                                </a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{ url('ho-tro-doanh-nghiep') }}" class="submenu-link">
                                                    <span>Hỗ trợ doanh nghiệp</span>
                                                </a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{ url('thu-nghiem-khao-nghiem-cong-nghe') }}" class="submenu-link">
