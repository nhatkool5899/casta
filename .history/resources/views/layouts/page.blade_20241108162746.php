                    ...
                    <div class="header-main">
                        ...
                        <div class="header-body">
                            ...
                            <ul class="navigation">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('about')}}" class="nav-link">Dịch vụ <i class="fa-sharp-duotone fa-solid fa-caret-down"></i></a>
                                    <div class="submenu">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('services')}}" class="nav-link">Thông tin <i class="fa-sharp-duotone fa-solid fa-caret-down"></i></a>
                                    <div class="submenu">
                                        <ul class="submenu-list">
                                            <li class="submenu-item">
                                                <a href="{{ route('about') }}" class="submenu-link about-redirect" data-section="section1">
