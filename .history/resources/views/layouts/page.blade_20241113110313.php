                            ...
                            <div class="nav_mobile-menu">
                                <ul class="nav_mobile-list">
                                    ...
                                    <li class="nav-item slide-drop">
                                        ...
                                        <ul class="nav-submobile submobile">
                                            <li class="nav-submobile-item">
                                                <a href="{{url('chuyen-giao-cong-nghe')}}" class="nav-submobile-item">Chuyển giao công nghệ</a>
                                            </li>
                                            <li class="nav-submobile-item">
                                                <a href="{{url('ho-tro-doanh-nghiep')}}" class="nav-submobile-item">Hỗ trợ doanh nghiệp</a>
                                            </li>
                                            <li class="nav-submobile-item">
                                                <a href="{{url('thuc-nghiem-khao-nghiem-cong-nghe')}}" class="nav-submobile-item">Thực nghiệm - Khảo nghiệm công nghệ</a>
                                            </li>
                                            <li class="nav-submobile-item">
                                                <a href="{{url('dao-tao')}}" class="nav-submobile-item">Đào tạo</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="nav-item slide-drop">
                                        ...
                                        <ul class="nav-submobile submobile">
                                            <li class="nav-submobile-item">
                                                <a href="{{url('su-kien')}}" class="nav-submobile-item">Sự kiên</a>
                                            </li>
                                            <li class="nav-submobile-item">
                                                <a href="{{url('tin-tuc')}}" class="nav-submobile-item">Tin tức</a>
                                            </li>
                                            <li class="nav-submobile-item">
                                                <a href="{{url('metag+')}}" class="nav-submobile-item">MetaG+</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <div class="submenu">
                                        <ul class="submenu-list">
                                            <li class="submenu-item">
                                                <a href="{{ url('chuyen-giao-cong-nghe') }}" class="nav-submobile-item">
                                                    <span>Chuyển giao công nghệ</span>
                                                </a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{ url('ho-tro-doanh-nghiep') }}" class="nav-submobile-item">
                                                    <span>Hỗ trợ doanh nghiệp</span>
                                                </a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{ url('thu-nghiem-khao-nghiem-cong-nghe') }}" class="nav-submobile-item">
