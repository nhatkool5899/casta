...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('front-end/assets/imgs/logo/logo.png')}}" rel="icon">
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item style dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{asset('front-end/assets/imgs/logo/logo.png')}}" alt="Profile" class="rounded-circle">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="{{url('about-page/index')}}">
            <i class="bi bi-file-code"></i><span>Trang giới thiệu</span>
          </a>
        </li>

        {{-- <li class="nav-item">
          <a class="nav-link collapsed" href="{{route('category.index')}}">
            <i class="bi bi-newspaper"></i><span>Danh mục dịch vụ</span>
          </a>
        </li> --}}
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="{{route('customer.index')}}">
            <i class="bi bi-newspaper"></i><span>Quản lí khách hàng</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link collapsed" href="{{route('policy.index')}}">
            <i class="bi bi-newspaper"></i><span>Các chính sách</span>
          </a>
        </li>
        ...
        {{-- <li class="nav-item">
          <a class="nav-link collapsed">
            <i class="bi bi-gem"></i><span>Quản lý người liên hệ</span>
          </a>
          <div class="dropdown-menu">
            <a href="{{url('customer/index/1')}}" class="dropdown-item">
              Form liên hệ
            </a>
            <a href="{{url('customer/index/2')}}" class="dropdown-item">
              Đăng ký nhận tin
            </a>
            <a href="{{url('customer/index/3')}}" class="dropdown-item">
              Nhận profile
            </a>
          </div>
        </li> --}}
        ...
        {{-- <li class="nav-item">
          <a class="nav-link collapsed" href="{{route('footer.index')}}">
          <i class="bi bi-gem"></i><span>Chân trang</span>
          </a>
        </li> --}}
        

        {{-- <li class="nav-item">
          <a class="nav-link collapsed" href="{{url('social/edit')}}">
          <i class="bi bi-gem"></i><span>Mạng xã hội</span>
          </a>
        </li> --}}
