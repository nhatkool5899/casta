					...
					<form id="formContact" method="post" class="">
						...
						<div class="form-flex">
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="div_input">
										<input type="text" name="phone" id="phone" class="required form-control" placeholder="Điện thoại *">
									</div>
								</div>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="div_input">
										<input type="text" name="address" id="address" class="required form-control" placeholder="Địa chỉ *">
									</div>
								</div>
							</div>
							<div class="col-md-12">
