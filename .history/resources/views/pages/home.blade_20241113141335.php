    ...
    <section class="section">
        <div class="container">
            ...
            <div class="wrapper-news">
                ...
                <div class="news-prev-slide slide-btn-mid"><i class="fa-solid fa-chevron-left"></i></div>
                <div class="news-next-slide slide-btn-mid"><i class="fa-solid fa-chevron-right"></i></div>
            </div>
        </div>
    </section>
