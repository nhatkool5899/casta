...
@section('banner')
    <div class="banner">
        ...
        <div class="swiper banner-swiper">
                        ...
                        <div class="container">
                            <div class="banner-context">
                                ...
                                <div class="banner-button">
                                    <a href="#" class="button-1">Giới thiệu</a>
                                    <a href="#" class="button-1 button-default">Tư vấn</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="banner-button-prev button-swiper"><i class="fa-light fa-chevron-left"></i></div>
            <div class="banner-button-next button-swiper"><i class="fa-light fa-chevron-right"></i></div>
        </div>
