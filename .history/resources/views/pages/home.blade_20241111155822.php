            ...
            <div class="news-home">
                <div class="news-slider">
                    <div class="news-slider-item">
                        <div class="news-content">
                            <div class="news-image">
                                <img src="{{asset('front-end/assets/imgs/news/post_01.jpg')}}" alt="">
                            </div>
                            <div class="news-data">
                                <div class="news-info">
                                    <span class="date">
                                ...
                                <div class="news-title">Đặt nền móng cho công trình xưởng thép Đông Á</div>
                                <div class="news-desc">
                                    Với diện tích rộng lớn hơn 30.000m vuông, công trình xưởng thép Đông Á hứa hẹn sẽ là tập đoàn cung cấp số 1....
                                </div>
                                <div class="read-mode">
                    ...
                    <div class="news-slider-item">
                        <div class="news-content">
                            <div class="news-image">
                                <img src="{{asset('front-end/assets/imgs/news/post_02.jpg')}}" alt="">
                            </div>
                            <div class="news-data">
                                <div class="news-info">
                                    <span class="date">
                    ...
                    <div class="news-slider-item">
                        <div class="news-content">
                            <div class="news-image">
                                <img src="{{asset('front-end/assets/imgs/news/post_03.jpg')}}" alt="">
                            </div>
                            <div class="news-data">
                                <div class="news-info">
                                    <span class="date">
                    ...
                    <div class="news-slider-item">
                        <div class="news-content">
                            <div class="news-image">
                                <img src="{{asset('front-end/assets/imgs/news/post_04.jpg')}}" alt="">
                            </div>
                            <div class="news-data">
                                <div class="news-info">
                                    <span class="date">
                    ...
                    <div class="news-slider-item">
                        <div class="news-content">
                            <div class="news-image">
                                <img src="{{asset('front-end/assets/imgs/news/post_05.jpg')}}" alt="">
                            </div>
                            <div class="news-data">
                                <div class="news-info">
                                    <span class="date">
