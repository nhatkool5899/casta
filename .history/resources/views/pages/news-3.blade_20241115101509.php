        ...
        <div class="product-home product-grid">
            ...
            <div class="product-content">
                ...
                <div class="product-data">
                    ...
                    <a href="#" class="product-title">🍇 Nho Mẫu Đơn Cậu Mười – Trái Nho Thượng Hạng, Dinh Dưỡng Tinh Tế! 🍇</a>
                    <div class="product-desc">
                        Gạo Jasmine, một loại gạo thơm ngon đặc trưng, đang ngày càng trở nên phổ biến nhờ hương vị thơm dẻo đặc biệt và giá trị dinh dưỡng vượt trội. Trên hệ thống truy xuất nguồn gốc hàng hóa thành phố Cần Thơ, gạo Jasmine được giám sát chặt chẽ từ khâu[…]
                    </div>
                    <div class="read-mode">
            ...
            <div class="product-content">
                <div class="product-image">
                    <img src="https://ttud.com.vn/wp-content/uploads/2024/10/3658_atiso-do-kho_1.jpeg" alt="product">
                </div>
                <div class="product-data">
                    <div class="product-info">
                        <span class="date">
                    ...
                    <a href="#" class="product-title">🌺 Atiso Đỏ Khô Hana Farm – Thức Uống Thanh Mát, Dinh Dưỡng Tự Nhiên! 🌺</a>
                    <div class="product-desc">
                        Khám Phá Lợi Ích Thú Vị Từ Atiso Đỏ Khô Hana Farm (Hibiscus) Qua Hệ Thống Truy Xuất Nguồn Gốc Hàng Hóa Thành Phố Cần Thơ ✨ Atiso đỏ khô Hana Farm là món quà từ thiên nhiên với hương vị chua dịu, ngọt thanh và vô số lợi ích cho sức khỏe. Sản phẩm được kiểm soát nghiêm ngặt qua hệ thống truy xuất nguồn gốc hàng hóa tại Cần Thơ,
                    </div>
                    <div class="read-mode">
                        Đọc thêm <i class="fa-regular fa-arrow-right"></i>
                    </div>
