                        ...
                        <div class="swiper-slide">
                            <div class="product-content">
                                ...
                                <div class="product-data">
                                    ...
                                    <a href="{{url('chi-tiet-tin-tuc')}}" class="product-title">Cá Tra – Sản Phẩm Nông Nghiệp Chủ Lực Tại Cần Thơ, Bước Đột Phá Với Hệ Thống Truy Xuất Nguồn Gốc</a>
                        ...
                        <div class="swiper-slide">
                            <div class="product-content">
                                ...
                                <div class="product-data">
                                    ...
                                    <a href="{{url('chi-tiet-tin-tuc')}}" class="product-title">Gạo Jasmine – Tinh Túy Thiên Nhiên, Dinh Dưỡng Vượt Trội!</a>
                                    <div class="product-desc">
                        ...
                        <div class="swiper-slide">
                            <div class="product-content">
                                ...
                                <div class="product-data">
                                    ...
                                    <a href="{{url('chi-tiet-tin-tuc')}}" class="product-title">Khô Cá Cơm Bánh Tráng – Hương Vị Giòn Tan, Dinh Dưỡng Tuyệt Vời! 🐟</a>
                                    <div class="product-desc">
                            ...
                            <div class="news-inner">
                                ...
                                <div class="news-inner-context">
                                    ...
                                    <div class="news-inner-bot">
                                        ...
                                        <a href="{{route('about')}}" class="btn-primary btn-news">
                                            Xem thêm<i class="fa-regular fa-chevron-right"></i>
                                        </a>
                ...
                <div class="swiper swiper-news">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="news-inner">
                                <a href="{{url('chi-tiet-tin-tuc')}}" class="news-inner-img">
                                    <img src="https://www.idiseafood.com/vnt_upload/news/07_2022/1_idi_tap_nap_cho_mot_mua_kinh_doanh_thuan_loi_2890.jpg" alt="image">
                                </a>
                                <div class="news-inner-context">
                                    <a href="{{url('chi-tiet-tin-tuc')}}" class="news-inner-name">IDI - VIÊN NGỌC SÁNG CỦA VÙNG ĐẤT CỬU LONG</a>
                                    <div class="news-inner-bot">
                                        <div class="news-inner-info">
                                            <span><i class="fa-regular fa-calendar"></i> 11/11/2024</span>
                                            <span><i class="fa-regular fa-eye"></i> 5899</span>
                        ...
                        <div class="swiper-slide">
                            <div class="news-inner">
                                <a href="{{url('chi-tiet-tin-tuc')}}" class="news-inner-img">
                                    <img src="https://www.idiseafood.com/vnt_upload/news/h1_ohzz.jpg" alt="image">
                                </a>
                                <div class="news-inner-context">
                                    <a href="{{url('chi-tiet-tin-tuc')}}" class="news-inner-name">Cá tra Việt Nam tiếp tục quẫy đuôi du lịch</a>
                                    <div class="news-inner-bot">
                                        <div class="news-inner-info">
                                            <span><i class="fa-regular fa-calendar"></i> 11/11/2024</span>
                                            <span><i class="fa-regular fa-eye"></i> 5899</span>
