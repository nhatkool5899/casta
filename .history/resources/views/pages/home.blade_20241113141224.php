    ...
    <section class="section">
        <div class="container">
            ...
            <div class="wrapper-news">
                <div class="swiper swiper-news">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="news-inner">
                                <a href="{{url('chi-tiet-tin-tuc')}}" class="news-inner-img">
                                    <img src="<div class="swiper-slide">
                            <div class="news-inner">
                                <a href="{{url('chi-tiet-tin-tuc')}}" class="news-inner-img">
                                    <img src="https://www.idiseafood.com/vnt_upload/news/07_2023/Picture3.png" alt="image">
                                </a>
                ...
                <div class="news-prev-slide"><i class="fa-regular fa-chevron-left"></i></div>
                <div class="news-next-slide"><i class="fa-regular fa-chevron-right"></i></div>
            </div>
        </div>
    </section>
