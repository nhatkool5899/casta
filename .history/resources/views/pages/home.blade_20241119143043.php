                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="news-inner">
                                ...
                                <div class="news-inner-context">
                                    <a href="{{url('chi-tiet-tin-tuc/'.$item->slug)}}" class="news-inner-name">
                        ...
                        <div class="swiper-slide">
                            <div class="news-inner">
                                ...
                                <div class="news-inner-context">
                                    <a href="{{url('chi-tiet-tin-tuc/'.$item->slug)}}" class="news-inner-name">Trách nhiệm bảo vệ môi trường là chìa khóa giúp doanh nghiệp phát triển bền vững</a>
                                    <div class="news-inner-bot">
                                        <div class="news-inner-info">
                                            <span><i class="fa-regular fa-calendar"></i> 11/11/2024</span>
                                            <span><i class="fa-regular fa-eye"></i> 5899</span>
                        ...
                        <div class="swiper-slide">
                            <div class="news-inner">
                                ...
                                <div class="news-inner-context">
                                    <a href="{{url('chi-tiet-tin-tuc/'.$item->slug)}}" class="news-inner-name">DOANH NGHIỆP ẤN ĐỘ KẾT NỐI CƠ HỘI HỢP TÁC KINH DOANH VỚI LĨNH VỰC  THỦY SẢN CỦA TẬP ĐOÀN SAO MAI</a>
                                    <div class="news-inner-bot">
                                        <div class="news-inner-info">
                                            <span><i class="fa-regular fa-calendar"></i> 11/11/2024</span>
                                            <span><i class="fa-regular fa-eye"></i> 5899</span>
                        ...
                        <div class="swiper-slide">
                            <div class="news-inner">
                                ...
                                <div class="news-inner-context">
                                    <a href="{{url('chi-tiet-tin-tuc/'.$item->slug)}}" class="news-inner-name">Giải pháp, công cụ loại bỏ lãng phí vận chuyển trong năng suất</a>
                                    <div class="news-inner-bot">
                                        <div class="news-inner-info">
                                            <span><i class="fa-regular fa-calendar"></i> 11/11/2024</span>
                                            <span><i class="fa-regular fa-eye"></i> 5899</span>
