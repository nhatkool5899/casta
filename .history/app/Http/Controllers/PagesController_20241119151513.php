...
class  PagesController extends Controller
{
    ...
    public function about(Request $request) {
        ...
        return view('pages.about', compact('ogTitle', 'sv_menu'));
    }
    ...
    public function service($slug) {
        ...
        return view('pages.service', compact('ogTitle', 'service', 'sv_menu', 'banner'));
    }
    ...
    public function about_1(Request $request) {
        ...
        return view('pages.about-1', compact('ogTitle', 'sv_menu'));
    }
    ...
    public function about_2(Request $request) {
        ...
        return view('pages.about-2', compact('ogTitle', 'sv_menu'));
    }
    ...
    public function about_3(Request $request) {
        ...
        return view('pages.about-3', compact('ogTitle', 'sv_menu'));
    }

    public function recruit(Request $request) {
        $ogTitle = "Tin tuyển dụng - CASTA";
        $sv_menu = Service::all();
        $news = News::where('category_id', 4)->orderBy('id','desc')->get();
        
        return view('pages.recruit', compact('ogTitle', 'sv_menu', 'news'));
    }
    ...
    public function news_1(Request $request) {
        ...
        return view('pages.news-1', compact('ogTitle', 'news', 'sv_menu', 'banner'));
    }
    ...
    public function news_2(Request $request) {
        ...
        return view('pages.news-2', compact('ogTitle', 'news', 'sv_menu', 'banner'));
    }
    ...
    public function news_3(Request $request) {
        ...
        return view('pages.news-3', compact('ogTitle', 'news', 'sv_menu','banner'));
    }
    ...
    public function contact() {
        ...
        return view('pages.contact', compact('ogTitle', 'sv_menu'));
    }
    ...
    public function search(Request $request) {
        ...
        return view('pages.search', compact('ogTitle', 'keyword', 'news', 'sv_menu'));
    }
}
