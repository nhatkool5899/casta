                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select name="category" class="form-select">
                                        ...
                                        <option {{ $banner->category == 2 ? 'selected' : '' }} value="3">Dịch vụ</option>
                                        <option {{ $banner->category == 3 ? 'selected' : '' }} value="4">Thông tinc</option>
                                        <option {{ $banner->category == 4 ? 'selected' : '' }} value="5">Cung cầu CN</option>
                                        <option {{ $banner->category == 5 ? 'selected' : '' }} value="6">Về trung tâm</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
