...
<body>
    <div class="app">
                ...
                <div class="header-top">
                    <div class="container">
                        <div class="header-top-main">
                            <div class="top-info">
                                <div class="top-inner">
                                        <span class="top-inner-icon">
                                            <i class="fa-solid fa-phone"></i>
                                        </span>
                                        <span>0704 888 009</span>
                                </div>
                                <div class="top-inner">
                                    <span class="top-inner-icon">
                                        <i class="fa-solid fa-envelope"></i>
                                    </span>
                                    <span>design24.vn@gmail.com</span>
                                </div>
                            </div>
                        ...
                        <div class="header-main">
                                    ...
                                    <ul class="nav_mobile-list">
                                        ...
                                        <li class="nav-item slide-drop">
                                            ...
                                            <ul class="nav-submobile submobile">
                                                @foreach ($sv_menu as $item)                                    
                                                <li class="nav-submobile-item">
                                                    <a href="{{url('dich-vu/'.$item->slug)}}" class="nav-submobile-link">{{$item->name}}</a>
                                                </li>
                                                @endforeach
                                            </ul>
                                        </li>
                                        ...
                                        <li class="nav-item slide-drop">
                                            ...
                                            <ul class="nav-submobile submobile">
                                                <li class="nav-submobile-item">
                                                    <a href="{{url('gioi-thieu')}}" class="nav-submobile-link">Giới thiệu</a>
                                                </li>
                                                <li class="nav-submobile-item">
                                                    <a href="{{url('co-cau-to-chuc')}}" class="nav-submobile-link">Cơ cấu tổ chức</a>
                                                </li>
                                                <li class="nav-submobile-item">
                                                    <a href="{{url('thanh-tich-dat-duoc')}}" class="nav-submobile-link">Thành tích đạt được</a>
                                                </li>
                                                <li class="nav-submobile-item">
                                                    <a href="{{url('tuyen-dung')}}" class="nav-submobile-link">Tuyển dụng</a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <div class="header-logo">
                                <a href="{{route('home')}}" class="logo-link">
                                    <img src="{{asset('front-end/assets/imgs/logo/logo-trans.png')}}" alt="logo-mekongcert">
                                </a>
                            </div>
                            <div class="header-body">
                                <ul class="navigation">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{url('chuyen-giao-cong-nghe')}}" class="nav-link">Dịch vụ <i class="fa-sharp fa-solid fa-caret-down"></i></a>
                                        <div class="submenu">
                                            <ul class="submenu-list">
                                                @foreach ($sv_menu as $item)                                    
                                                <li class="submenu-item">
                                                    <a href="{{ url('dich-vu/'.$item->slug) }}" class="submenu-link">
                                                        <span>{{$item->name}}</span>
                                                    </a>
                                                </li>
                                                @endforeach
                                    ...
                                    <li class="nav-item">
                                        <a href="{{url('su-kien')}}" class="nav-link">Thông tin <i class="fa-sharp fa-solid fa-caret-down"></i></a>
                                        <div class="submenu">
                                            <ul class="submenu-list">
                                                <li class="submenu-item">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="submenu">
                                            <ul class="submenu-list">
                                                <li class="submenu-item">
                                                    <a href="{{ route('about') }}" class="submenu-link">
                                                        <span>Giới thiệu về trung tâm</span>
                                                    </a>
                                                </li>
                                                <li class="submenu-item">
                                                    <a href="{{ url('co-cau-to-chuc') }}" class="submenu-link">
                                                        <span>Cơ cấu tổ chức</span>
                                                    </a>
                                                </li>
                                                <li class="submenu-item">
                                                    <a href="{{ url('thanh-tich-dat-duoc') }}" class="submenu-link">
                                                        <span>Thành tích đạt được</span>
                                                    </a>
                                                </li>
                                                <li class="submenu-item">
                                                    <a href="{{ url('tuyen-dung') }}" class="submenu-link">
        ...
        <footer>
            <div class="footer">
                <span class="shape-1" style="left:-25px;opacity:0.3;top:0">
                    <img src="{{asset('front-end/assets/imgs/cay-lua.png')}}" alt="shape-4">
                </span>
                <div class="container">
                    <div class="ft-body">
                        <div class="ft-left">
